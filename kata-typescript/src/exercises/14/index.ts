...
export function map<T>(mapper: () => T, input: Array<T>): Array<T> | Function {
...
export function filter<T>(filterer: () => T, input: Array<T>): Array<T> | Function {
    if (arguments.length === 0) {
        return filter;
    }
    if (arguments.length === 1) {
...
// export function reduce<T, U>(reducer: (accumulator: U, item: T) => U, initialValue: U, input: T[]): U;
// export function reduce<T, U>(reducer: (accumulator: U, item: T) => U, initialValue: U): (input: T[]) => U;
// export function reduce<T, U>(reducer: (accumulator: U, item: T) => U): (initialValue: U) => (input: T[]) => U;
...
export function reduce<T, U>(
    ...
    if (arguments.length === 1) {
        return function subFunction(subInitialValue: U, subInput: Array<T>) {
            if (arguments.length === 0) {
                return subFunction;
            }
            if (arguments.length === 1) {
                return function subSubFunction(subSubInput: Array<T>) {
                    if (arguments.length === 0) {
...
export function prop<T, K extends keyof T>(obj: T, propName: K): T[K] | Function {
    ...
    if (arguments.length === 1) {
        return function subFunction(subPropName: K): T[K] | Function {
            if (arguments.length === 0) {
                return subFunction;
            }
...
export function pipe(...functions: Function[]): Function {
    ...
    return function subFunction(...args: Function[]): Function {
