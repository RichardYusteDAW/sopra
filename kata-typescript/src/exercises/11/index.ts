/*
Hay que crear un archivo de declaración para el módulo str-utils
donde hay un "declare"
Y en el tsconfig.json hay que agregar 
el path de la carpeta declarations en typeRoots
*/
